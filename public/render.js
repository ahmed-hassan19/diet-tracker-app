...
function renderPlan(){
  ...
  <div class="card"><h2>🎯 الأهداف اليومية</h2>
    ...
    <div class="note">📊 استخدم <b>متوسط 3 أسابيع</b>: لو النزول 0.4–0.8 كجم/أسبوع كمّل. لو أسرع من 0.8 بعد أول أسبوعين، أو القوة/الدوخة ساءت، زوّد 100–200 سعر. لو أقل من 0.4 مع تسجيل دقيق 3 أسابيع، قلّل 100–150 سعر. متعوّضش التمرين بأكل إضافي تلقائيًا؛ النشاط داخل تقدير الهدف بالفعل.</div>
...
function renderProg(){
  ...
  <div class="card"><h2>📅 متوسط أسبوعي</h2>
    ...
    <p class="muted" style="margin-top:8px">الهدف الحالي: 0.4–0.8 كجم في الأسبوع بعد أول أسبوعين. بص على متوسط 3 أسابيع لأن المياه ممكن تخفي الاتجاه الحقيقي.</p>
