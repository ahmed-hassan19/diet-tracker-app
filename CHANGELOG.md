...
- مسح الأكلات والإضافات المخصصة بقى من النهارده وطالع، مع الحفاظ على اختيارات
  الأيام اللي فاتت وقيمها الغذائية، حتى لو المسح اتعمل وإنت فاتح يوم قديم.

### Changed

- مراجعة الإصدار بقت بتستخدم نجاح CI لنفس نسخة `main` بالظبط، مع فحص إعدادات
  حديث خلال 24 ساعة وإعادة استخدام مراجعة الأمان لمدة 30 يوم لو مدخلاتها متغيّرتش.

## [3.15.0] - 2026-09-13

### Added

- تفاصيل نقاط منحنى الوزن بالماوس واللمس والكيبورد: التاريخ والوزن، والتغيير من
  آخر وزن مسجّل، وفرق متوسط الأسبوع عن الأسبوع التقويمي اللي قبله.

### Changed

- تقدير AI وحفظ البيانات على السحابة بقوا متاحين لكل حساب مسجّل دخوله، من غير
  دعوة أو تفعيل يدوي، مع استمرار خصوصية بيانات كل حساب وإفصاح مشاركة بيانات AI.
- المتوسط الأسبوعي مبقاش يقارن بأسابيع أقدم لو الأسبوع اللي قبله مفيهوش وزن مسجّل.

## [3.14.1] - 2026-09-02

### Fixed

- تسجيل الدخول بحساب Google على الموبايل بقى يستخدم تحويل آمن بدل نافذة منبثقة،
  مع إكمال نتيجة الرجوع على نفس نطاق الموقع.

## [3.14.0] - 2026-08-29

### Added

- تقدير AI رجع للحسابات التجريبية المفعّلة، مع بقاء الإدخال والحفظ اليدوي
  متاحين دايمًا ومن غير حفظ أي مسودة مولّدة تلقائيًا.

### Changed

- اختيار الموديل بقى `gemini-flash-lite-latest` بناءً على قبول إن الاسم ده
  ممكن يتحوّل تلقائيًا لإصدار ثابت أو تجريبي أو معاينة من غير إصدار جديد
  للتطبيق؛ مفيش موديل احتياطي وقت التشغيل.

### Fixed

- سياسة أمان المحتوى بقت تسمح باتصال reCAPTCHA المطلوب، وسياسة الصلاحيات بقت
  تدي Storage Access بشكل محدود لنطاقَي reCAPTCHA بس، فاختفت أخطاء الكونسول
  اللي عطلت نشر التفعيل السابق.

### Security

- فضل App Check ووضع المستخدمين المسجلين وقراءة العضوية الجديدة وحصة الطلبات
  واستبعاد محتوى السجلات وشرط Spark من غير Billing زي ما هم. لو الاسم المتحرك
  اختار موديل غير متاح مجانًا، الطلب يفشل والإدخال اليدوي يفضل شغال.

## [3.13.1] - 2026-08-28

### Fixed

- اتوقف تقدير AI مؤقتًا بعد ما التحقق على الموقع الفعلي كشف أخطاء أمان محتوى
  من reCAPTCHA؛ الإدخال والحفظ اليدوي شغالين بالكامل لكل المستخدمين.

### Security

- فضل App Check ووضع المستخدمين المسجلين وحصة الطلبات واستبعاد محتوى السجلات
  وشرط Spark من غير Billing زي ما هم، من غير توسيع سياسة أمان المحتوى أو تغيير
  الموديل.
...
- تقدير AI بقى ظاهر للحسابات التجريبية المفعّلة في إضافة الأكلات ودليل السعرات،
  مع بقاء الإدخال والحفظ اليدوي متاحين لكل المستخدمين ومن غير حفظ المسودة تلقائيًا.

### Changed

- رسائل فشل تقدير AI بقت تفرّق بين عضوية غير مفعّلة، جلسة منتهية، رفض تحقق
  الجلسة أو أمان التطبيق، نفاد الحصة، انقطاع الشبكة، والرد غير الصالح.
- عقد تحقق الإصدار بقى بالمخطط 6، ويقبل رفض طلب App Check غير الصالح بحالة
  `401` أو `403` بعد نجاح طلب تحكم صالح في نفس الجلسة والتأكد إن الطلب المرفوض
  مطلعش أي نتيجة من الموديل؛ طلب من غير تسجيل دخول لازم يفضل `401`.

### Security

- كل طلب AI لسه محتاج مستخدم Firebase الحالي وقراءة سيرفر جديدة لعضوية مفعّلة
  قبل استدعاء الموديل، مع بقاء App Check ووضع المستخدمين المسجلين وحصة 6 طلبات
  في الدقيقة لكل مستخدم واستبعاد محتوى السجلات وشرط Spark من غير Billing.

## [3.12.0] - 2026-08-28

### Changed

- اتشالت شاشة التنبيه الصحي وخطوات الموافقة، فالمستخدم بيفتح الإعداد أو المتابعة
  مباشرة، واتشالت الرسائل المرتبطة بيها من الواجهة وصفحات الشرح والخصوصية.
- حقول تأكيد التنبيه القديمة بقت تتقبل كزوج إصدار 1 صالح عند حد التطبيع بس،
  وتتشل من الحالة الحالية والتصدير والتخزين المحلي بعد كتابة وقراءة متحققة.

### Security

- قواعد Firestore بقت ترفض كتابة حقول تأكيد التنبيه المتوقفة، مع استمرار صاحب
  البيانات في قراءة أو حذف مستند قديم واستبداله بصورة حالية كاملة عند تفعيل الحفظ.
...
- نطاق تغيّر الوزن الأسبوعي بقى مشتق من فرق احتياج الطاقة عن طرفي هدف السعرات
  الحالي، فبيعكس أرضية BMR وسقف العجز والتعديلات اليدوية بدل نطاق نسبي ثابت.
- اتشالت إحالات العبوات التجارية اللي مبتثبتش الحصة المعروضة، واتحسبت بدائل
  القهوة والعسل الحالية من أوزان ومصادر FNDDS من غير استثناءات تقرّب الماكروز
  بعيدًا عن المصدر؛ والخيارات التاريخية ٤٤ جم بقت مرتبطة بسجل ملصق NIH المحدد.
- التسجيلات المحفوظة قبل تحديث بدائل القهوة والعسل بتحتفظ بالاسم والقيم القديمة
  من خلال ترحيل إصدار واضح، من غير ما تغيّر فهارس الاختيارات الحالية أو سجل
  مصادر الـ75 إدخال.
- قواعد Firestore بقت تقبل حدود الحالة الكاملة اللي بيفرضها التطبيق، بما فيها
  أماكن الأكلات المحذوفة، من غير ما تتخطى حد تعبيرات القواعد.

### Security

- قواعد Firestore بتحافظ على ملكية المستند، وبوابة العضوية، والمفاتيح والأنواع
  والحدود لكل قائمة؛ والتحقق الكامل من تواريخ الأيام وإجمالي الأكلات النشطة
  بيفضل عند حد التطبيع قبل الحفظ عشان القواعد متمنعش حالة تطبيق صالحة.
